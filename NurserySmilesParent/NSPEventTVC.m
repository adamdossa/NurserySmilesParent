...
#import "NSPEventTVC.h"

@interface NSPEventTVC ()

@end

@implementation NSPEventTVC
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.destinationViewController respondsToSelector:@selector(setQueryDate:)]) {
        [segue.destinationViewController performSelector:@selector(setQueryDate:) withObject:self.queryDate];
    }
}
