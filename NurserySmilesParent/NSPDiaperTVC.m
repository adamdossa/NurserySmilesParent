...
#import "NSPDiaperTVC.h"

@interface NSPDiaperTVC ()

@end

@implementation NSPDiaperTVC
...
- (void) initVars
{
    if (self) {
        ...
        self.parseClassName = @"DiaperChange";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    static NSString *CellIdentifier = @"DiaperInfo";
    ...
    // Configure the cell
    NSString *typeString = (NSString*) [object objectForKey:@"type"];
    NSNumber *cream = [object objectForKey:@"cream"];
