...
#import "NSPSleepTVC.h"

@interface NSPSleepTVC ()

@end

@implementation NSPSleepTVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    static NSString *CellIdentifier = @"SleepInfo";
    ...
    cell.textLabel.text = [@"Duration: " stringByAppendingString:durationString];
